	...
	return (
		<div className='md:px-20'>
			<Swiper
				...
				className={`h-96 bg-white sm:hidden`}
			>
				...
				<SwiperSlide className='w-96 h-96  py-6 px-6  rounded-3xl '>
					<div className='bg-white shadow-md h-full  border-t-4 border-gray-700'>
						<div className='flex justify-center w-full -translate-y-4'>
							<div className='h-14 w-14 overflow-hidden rounded-full '>
								<img src={require("../images/nath.jpg")} alt='' />
							</div>
						</div>
						<div className='flex flex-col items-center'>
							<h4 className='font-bold text-sm'>alex</h4>
			...
			<Swiper
				...
				navigation={true}
				modules={[Pagination, Navigation]}
				className={`h-96 bg-white hidden  sm:block `}
			>
				<SwiperSlide className='w-96 h-96  py-6 px-6  rounded-3xl '>
					<div className='bg-white shadow-md h-full  border-t-4 border-gray-700'>
						<div className='flex justify-center w-full -translate-y-4'>
						...
						<div className='flex flex-col items-center'>
							<h4 className='font-bold text-sm'>Samuel</h4>
							<h4 className='font-semibold text-base'>software engineer</h4>
							<h4 className='font-bold text-sm'>google </h4>
						</div>
				...
				<SwiperSlide className='w-96 h-96  py-6 px-6  rounded-3xl '>
					<div className='bg-white shadow-md h-full  border-t-4 border-gray-700'>
						<div className='flex justify-center w-full -translate-y-4'>
							<div className='h-14 w-14 overflow-hidden rounded-full '>
								<img src={require("../images/nana.jpg")} alt='' />
							</div>
						</div>
						<div className='flex flex-col items-center'>
							<h4 className='font-bold text-sm'>nath</h4>
							<h4 className='font-semibold text-base'>software engineer</h4>
							<h4 className='font-bold text-sm'>google </h4>
						</div>
				...
				<SwiperSlide className='w-96 h-96  py-6 px-6  rounded-3xl '>
					<div className='bg-white shadow-md h-full  border-t-4 border-gray-700'>
						...
						<div className='flex flex-col items-center'>
							<h4 className='font-bold text-sm'>mohammed</h4>
							<h4 className='font-semibold text-base'>software engineer</h4>
							<h4 className='font-bold text-sm'>google </h4>
						</div>
