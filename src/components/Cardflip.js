	...
	return (
		<div className=''>
			<Swiper
				...
				grabCursor={true}
				modules={[EffectCards]}
				className='flex justify-center items-center h-96 w-80 '
			>
				<SwiperSlide className='w-96 h-96 bg-purple-700 rounded-xl flex justify-center items-center '>
					<div className='space-y-4 text-white'>
						<p className='text-4xl font-extrabold font-redressed'>
							<span className='text-yellow-500'>Luxstek's</span> core believes
						</p>
						<div className='w-full flex justify-center flex-col items-center'>
							<p className='text-xl font-bold'>values</p>
							<p className='text-2xl font-extrabold font-redressed'>
								& principles
							</p>
						</div>
					</div>
				...
				<SwiperSlide className='w-96 h-96 bg-stone-800 rounded-xl flex justify-center items-center '>
					<div className='space-y-4 text-white'>
						<div></div>
						<p className='text-4xl font-extrabold font-redressed w-full text-center'>
							imaginative power
						</p>
