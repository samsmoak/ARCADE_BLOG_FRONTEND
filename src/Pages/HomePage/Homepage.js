	...
	return (
		<div>
			<div className='grid grid-cols-2 '>
				<div className='w-full h-small1 bg-slate-800 flex justify-center items-center space-x-2'>
			...
			<div className='flex justify-center space-x-24'>
				<div className='w-96'>
					...
					<p className='text-xs text-gray-500'>
						...
						performance and where they need improvements; and leverage powerful
						integrations that offer a streamlined platform to help keep
			...
			<div className='flex justify-center space-x-24 py-40'>
				...
				<div className='w-96'>
					...
					<p className='text-2xl font-bold text-indigo-800'>Data & Reporting</p>
					<p className='text-xs text-gray-500'>
