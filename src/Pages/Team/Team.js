...
function Team() {
	return (
		<div>
			<div className='bg-[url("/src/images/wavy2.svg")] h-small1 w-screen flex justify-center items-center'>
			...
			<div className=' w-screen'>
				<div className='flex justify-center items-center py-20  bg-white'>
					<div className='grid grid-flow-col grid-cols-8 '>
						<div className='col-span-6 col-start-2 grid grid-cols-1 md:grid-cols-2 gap-x-3'>
