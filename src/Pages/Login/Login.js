	...
	return (
		<div className=''>
			<div className=' w-screen h-screen   bg-cover flex justify-center items-center  '>
				<div className='h-small2 w-96 bg-[url("/src/images/hakon.svg")] bg-opacity-50 rounded-xl py-10 px-4 border-t-2 border-r-4 border-b-2 border-opacity-30 border-gray-700'>
